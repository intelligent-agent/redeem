...
class M130_M131_M132_Tests(MockPrinter):
    ...
    def test_gcodes_M130_Pn_Sr(self):
        ...
        for k in self.heaters:
            ...
            self.execute_gcode("M130 P{} S{}".format(self.heaters.index(k)-1, expected_Kp[k]))
    ...
    def test_gcodes_M131_Pn_Sr(self):
        ...
        for k in self.heaters:
            ...
            self.execute_gcode("M131 P{} S{}".format(self.heaters.index(k)-1, expected_Ti[k]))
    ...
    def test_gcodes_M132_Pn_Sr(self):
        ...
        for k in self.heaters:
            ...
            self.execute_gcode("M132 P{} S{}".format(self.heaters.index(k)-1, expected_Td[k]))
