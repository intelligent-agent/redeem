...
#define STEPPER_X_END_MIN   14  //On GPIO 0
#define STEPPER_Y_END_MIN   2   //On GPIO 2
#define STEPPER_Z_END_MIN   30  //On GPIO 0
#define STEPPER_X_END_MAX   31  //On GPIO 0
#define STEPPER_Y_END_MAX   21  //On GPIO 3
#define STEPPER_Z_END_MAX   4   //On GPIO 0
