...
#define DLY_OFFSET		100*4			// Offset for delays (half of the available memory)
...
START:	
	...
	MOV  r4, PIN_OFFSET					// r4 is the pin counter
	MOV  r5, DLY_OFFSET					// r5 is the delay counter
SET_PINS:						
	...
	LBBO r0, r5, 0, 4					// Load Delay into r0
