...
int main(int argc, const char* argv[])
{
    ...
    end[0] = 20.5000620480408 / 1000.0;
    end[1] = 19.1339750384809 / 1000.0;
    start[0] = 62.000125628132 / 1000.0;
    start[1] = 18.2679500769617 / 1000.0;
    planner.queueMove(start, end, speed, false);
    start[0] = end[0];
    start[1] = end[1];

    end[0] = 41.0000934550738 / 1000.0;
    end[1] = 54.6409984607654 / 1000.0;
    planner.queueMove(start, end, speed, false);
    start[0] = end[0];
    start[1] = end[1];

    end[0] = 62.000125628132 / 1000.0;
    end[1] = 18.2679500769617 / 1000.0;
    planner.queueMove(start, end, speed, false);
    start[0] = end[0];
    start[1] = end[1];
